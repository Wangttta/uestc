...
def get_args():
    ...
    parser.add_argument("--n-batch", type=int, default=200, help="Number of experience for one mini-batch in training")
    ...
    parser.add_argument("--lr-decay-rate", type=float, default=0.95, help="")

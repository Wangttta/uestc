...
class Model:
    ...
    def __init__(self, args, env: MUMEC):
        ...
        self.drl_model = PPO(input_dim, output_dim, n_agent=env.N, n_train=args.n_train, lr=args.lr, lr_decay_rate=args.lr_decay_rate, epsilon=args.epsilon, gamma=args.gamma)
        # 3. Statistics
        self.step = 0
    ...
    def run(self):
        for episode in range(self.args.n_episode):
            ...
            self.writer.add_scalar('Model/Loss', self.drl_model.loss, episode)
